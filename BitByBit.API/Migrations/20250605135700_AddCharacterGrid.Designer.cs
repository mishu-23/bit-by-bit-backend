...
namespace BitByBit.API.Migrations
{
    ...
    [Migration("20250605135700_AddCharacterGrid")]
    partial class AddCharacterGrid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BitByBit.API.Models.CharacterGrid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("CharacterGrids");
                });

            modelBuilder.Entity("BitByBit.API.Models.GridCell", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CharacterGridId")
                        .HasColumnType("integer");

                    b.Property<int?>("PixelType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BitByBit.API.Models.GridCell", b =>
                {
                    b.HasOne("BitByBit.API.Models.CharacterGrid", "CharacterGrid")
                        .WithMany("Cells")
                        .HasForeignKey("CharacterGridId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CharacterGrid");
                });
